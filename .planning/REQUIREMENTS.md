...
- [x] **LEG-04**: A legal review gate passes before public launch, with the MEDDIC-family trademark status reconfirmed against current sources
- [x] **LEG-05**: README claims and badges derive only from committed benchmark results, with the model versions and date stated
