...
- [x] **DIST-01**: User can install via the skills CLI with one command
...
- [x] **DIST-06**: Reader gets a README that leads with before/after pairs and states install paths for each harness
