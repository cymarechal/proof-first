...
fixed_count: 11
total_count: 29
last_updated: 2026-09-21T11:15:18.544Z
---
...
| 29 | 06 | unrun-verify | NUMBERING.md |  | PF-1 sub-block list (NUMBERING.md:26-40): the seven Command of the Message elements -- Before scenario, After scenario, Required Capabilities, Metrics, Proof Points, Differentiators, Positive Business Outcomes -- are a source's own ordered list reproduced in its order, which SOURCES.md defines as reproduction, and NUMBERING.md's own prose says so on the table's face. Stronger than WINDOWS id 6 on every axis: no acronym defence is available, the mark (Command of the Message(R), Force Management) is live and unadjudicated with no genericness holding of the kind the 2026-04-21 MEDDPICC ruling supplied, and SOURCES.md prong 4 engages harder because Required Capabilities / Proof Points / Differentiators / Positive Business Outcomes are the framework's own vocabulary rather than neutral English. Weighing the other way: short noun phrases, no rule text taken from a source, NOTICES.md carries the attribution, and the list lives only in the internal ID registry -- no shipped file (SKILL.md, output style, system prompt) names these seven as a set in this order. Examined at the 2026-09-21 LEG-04 review (LEGAL-REVIEW.md, section 'The PF-1 sub-block list') and deliberately not closed: neither WINDOWS id 3 nor id 6 had read it, and the two deciding questions are whether an internal registry counts as shipping the list and whether prong 4 is answered by attribution or only by renaming. Closure condition: a decision on those two, or the cheap alternative the review names -- rename the seven sub-blocks to this repository's own terms, which costs nothing a reader depends on. | open |  | 2026-09-21T11:15:18.544Z |  |
...
[
  ...
  },
  {
    ...
    "status": "open",
    "reason": "Cold read PERFORMED 2026-09-21 by /gsd-verify-work 06 -- the 'no reader available' premise is cleared and must not be reused. Two independent headless readers, neither of which wrote the text, read README in a scratch directory on a neutral brief. On the specific question this entry carried (does the new claim region read as an honest report of a mixed result or a defensive one): PASS -- the reader's verdict was 'honest report of a mixed result, not a burial, and not close to one', noting the loss is pre-announced at :163, stated subject-verb-number at :181, given MORE sentence-level prominence than the two wins, and has its cheapest excuse foreclosed at :183. The entry stays OPEN on a different finding: the same readers surfaced three checkably-false README statements, recorded as gap G-06-6 in 06-UAT.md and planned in 06-05-PLAN.md. Closes when those three are corrected.",
  ...
  },
  {
    ...
    "file": "NUMBERING.md",
    "line": null,
    "description": "PF-1 sub-block list (NUMBERING.md:26-40): the seven Command of the Message elements -- Before scenario, After scenario, Required Capabilities, Metrics, Proof Points, Differentiators, Positive Business Outcomes -- are a source's own ordered list reproduced in its order, which SOURCES.md defines as reproduction, and NUMBERING.md's own prose says so on the table's face. Stronger than WINDOWS id 6 on every axis: no acronym defence is available, the mark (Command of the Message(R), Force Management) is live and unadjudicated with no genericness holding of the kind the 2026-04-21 MEDDPICC ruling supplied, and SOURCES.md prong 4 engages harder because Required Capabilities / Proof Points / Differentiators / Positive Business Outcomes are the framework's own vocabulary rather than neutral English. Weighing the other way: short noun phrases, no rule text taken from a source, NOTICES.md carries the attribution, and the list lives only in the internal ID registry -- no shipped file (SKILL.md, output style, system prompt) names these seven as a set in this order. Examined at the 2026-09-21 LEG-04 review (LEGAL-REVIEW.md, section 'The PF-1 sub-block list') and deliberately not closed: neither WINDOWS id 3 nor id 6 had read it, and the two deciding questions are whether an internal registry counts as shipping the list and whether prong 4 is answered by attribution or only by renaming. Closure condition: a decision on those two, or the cheap alternative the review names -- rename the seven sub-blocks to this repository's own terms, which costs nothing a reader depends on.",
    "status": "open",
    "reason": "",
