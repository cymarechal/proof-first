...
human_verification_performed: 34
human_verification_passed: 5
human_verification_issues: 29
uat_round: "/gsd-verify-work 06 round 8, 2026-09-23, against 8eca37d"
gap_closure_round: "06-12, 2026-09-23 — G-06-30..33 closed, awaiting round 9's independent read. Round 8 (2026-09-23, against 8eca37d) opened G-06-30..33 on ten checkably-false statements in shipped files and G-06-34 on twenty-two in .planning/, and confirmed 06-11's corrections unregressed. 06-12 closed the shipped ten in twelve tasks and twelve fix commits across four shipped files plus the ledger. Two of its outputs are structural rather than prose. First, the launch gate stopped misreporting itself: LEGAL-REVIEW.md had said at four sites since 06-02 (6cc615a) that Ardent Digital and Gina Almeida were routed to WINDOWS.md for a decision, and grep -c returned 0 for each name there — the routing landed as ledger id 34 rather than the sentences being deleted, because examples/deal-brief.md still carries both names and the review states neither collision is closed by it. Second, change 5 was widened to a reverse index (ledger id 35): for every file a round edits, re-run every committed literal and re-derive every stated measurement in every OTHER shipped file that names that path. Back-tested over 06-11's edit set at 8eca37d, it returns both literals 06-11 falsified, by their own wording. Six deviations recorded, three of them defects in this round's own first drafts caught before commit, and one a false sentence the plan itself supplied — 'in files it never opened' is true of one of the two literals, not both: 06-11 edited tools/check_repo.py three times. The reproduced ledger was re-rendered from the fence after each of the round's two ledger writes, fence first both times. Code-review gate: two Info findings in the round's own docstring edits, both fixed. All ten CI commands green throughout. Written and executed inline; the Agent tool is prohibited in this session."
gaps_closed: 10   # round 8's shipped ten, by 06-12. The 22 .planning/ findings went to backlog, not closure.
gaps_open: 0
gaps_open_ids: []   # G-06-30..33 closed by 06-12; round 9 reads the corrections
gaps_backlog_ids: [G-06-34]   # supersedes and absorbs G-06-29, whose 15 unfixed findings round 8 re-found
gaps_awaiting_independent_read: [G-06-30, G-06-31, G-06-32, G-06-33]   # closed by 06-12; round 9 is the independent read
