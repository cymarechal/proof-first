...
| 12 | 04 | DIST-06's prose-quality half, unchecked by any code here | **Open — v2** | Cold read PERFORMED 2026-09-21 and 2026-09-22, four rounds. Round 1's reader on the named question returned PASS — one reader, not two: round 1 ran five readers and its only pair was the README hunt, which returned three false statements; rounds 2, 3 and 4 re-read each round's corrections and found no regression of any fix. Stays open on the statements they found: three in round 1 (G-06-6, closed in 06-05), fourteen in round 2 (G-06-7, G-06-9, closed in 06-06), eleven in round 3 (G-06-10 to G-06-12, closed in 06-07) and seventeen in round 4 (G-06-13 to G-06-16, closed in 06-08). Ten of round 4's seventeen were authored by the commit closing round 3, up from four and two in the rounds before. Closes when a round returns none; four have not. |
